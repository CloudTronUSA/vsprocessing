...
/**
 * Manages all mermaid editor preview webviews.
...
export class MermaidWebviewManager {
	...
	public registerWebview(id: string, webview: vscode.Webview, mermaidSource: string, title: string | undefined): vscode.Disposable {
